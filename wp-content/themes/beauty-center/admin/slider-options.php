...
?>   
    ...
    <div style="padding:10px;float:left; font-size:14px;">
     ...
     <ol>
     <li>Use the main title text input as the slide title</li>
     ...
     <li>Use the <strong>"Featured Image"</strong> option from the rigth sidebar to add the slide image. The corect size is <strong>width: 940px</strong> and <strong>height 400px</strong> (the height can be diferent, but try to use the same height for all images, not to have one slide heigher than other)</li>
...
{
	add_meta_box('custom_meta', __('How to add an image in the slider:','admincore'), 'com_post_metaa', 'slider', 'normal', 'high');
}
