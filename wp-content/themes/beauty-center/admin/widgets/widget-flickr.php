...
class widget_flickr extends WP_Widget {
	...
	function widget_flickr() {
		...
		parent::WP_Widget(false, __('Widget - Flickr', 'admincore'),$widget_ops);      
	}
   ...
   function form($instance) {   
		...
		?>
       	<p>
            <label for="<?php echo $this->get_field_id('widgettitle'); ?>"><?php _e('Title:','admincore'); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('id'); ?>"><?php _e('Flickr ID:','admincore'); ?></label>
            <input type="text" name="<?php echo $this->get_field_name('id'); ?>" value="<?php echo $id; ?>" class="widefat" id="<?php echo $this->get_field_id('id'); ?>" />
        </p>
       	<p>
            <label for="<?php echo $this->get_field_id('number'); ?>"><?php _e('Thumbs number:','admincore'); ?></label>
