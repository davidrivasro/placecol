<?php if (PHP_VERSION_ID < 50400) { error_reporting (E_ALL ^ E_NOTICE); } else { error_reporting (E_ALL ^ E_NOTICE ^ E_STRICT); } ?>
<?php
class Admincore
{
    ...
    */
    ...
    function _definitions()
    {
        ...
        if(!defined('ADMINCORE_DIR')) {
            define('ADMINCORE_DIR', get_template_directory() . '/admin');
        }
    ...
    */
    ...
    {
        load_theme_textdomain('admincore', get_template_directory() . '/languages');
    }
